...
"""
Namespace(
    abort=None, archive=None, cfgfiles=None, clear_cache=None, 
    cookies=None, download=None, inputfiles=None, list_extractors=False, 
    list_modules=False, list_urls=None, load_config=True, logfile=None, 
    loglevel=20, mtime=None, netrc=None, options=[((), 'base-directory', 'D:/')], part=None, 
